    ...
    if ($_POST['password'] != $_POST['password_confirm']) {
        ...
        try{
            if(onlyuser(dbconnect_select(),$_POST['email']) && reg_user(dbconnect_insert())) {
                ...
                auditor(dbconnect_insert(),getnewuserid(dbconnect_select(),$_POST['email']),"reg", "Registration of new user");
                header("Location: index.php");
                exit;
            }
...
echo "<title> Register page</title>";  # sets the title of the page (web browser tab)
