...
echo "<title> Booking Page</title>";  # sets the title of the page (web browser tab)
...
echo "<h2> Rolsa Technologies - Booking System</h2>";  # sets a h2 heading as a welcome
echo "<br>";
